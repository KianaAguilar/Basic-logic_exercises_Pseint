/*Una persona decidió realizar un algoritmo para mostrar 3 números por pantalla. Decidió llamar a las
...
Escribir"" "Los numero de las variables son:" num1,    num2,num3;
